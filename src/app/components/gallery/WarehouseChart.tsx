...
export default function WarehouseChart() {
  ...
  return <section className={styles.warehouse} id="data" data-particle-surface data-warehouse aria-labelledby="data-heading">
    ...
    <div className={styles.warehouseFooter}><p>Separate datasets; counts are not additive.<br />Python · DuckDB · Parquet</p><Link className={styles.link} href="#project-nba-analytics-warehouse">Explore the warehouse ↗</Link></div>
  </section>;
}
